...
- Total papers in run: **52**
- Cutoff year (held-out count): **2024**
- Overall pack gate: **PASS**
...
- Min papers/gaps: 4/2 → ok
- Domain tag hist: `{'lnp': 6, 'endosomal_escape': 5, 'hybrid_ncrna': 5, 'gene_therapy': 4, 'targeting': 3, 'mrna': 2, 'sirna': 1, 'corona': 1}`
